...
<body>
	<nav class="bg-blue-800">
		<div class="h-24 font-sans text-base text-white w-3/4 mx-auto px-5 ">
			<ul class="list-none">
	...
	<section class="bg-sky-50">
		<div id="activity" class="font-sans text-sky-800 text-4xl w-3/4 py-6 mx-auto">
			<div class="text-4xl font-bold mb-6">Моя деятельность</div>
			<div class="text-9xl font-black flex lg:flex-row md:flex-col sm:flex-col">
	...
	<section class="bg-sky-50">
		<div id="difficulties" class="font-sans text-sky-800 text-4xl w-3/4 py-6 mx-auto">
	...
	<footer class="bg-blue-800">
		<div id="contacts" class="font-sans text-white w-3/4 flex mx-auto p-5">
			<div class="drop-shadow-md text-xl grow">Николай Ильин</div>
			<div class="text-base leading-7 px-5">+7&nbsp;917&nbsp;710&nbsp;33&nbsp;60</div>
			<div class="w-1/12"><a href="http://vk.com/dooomer"><img src="./img/vk.png" /></a></div>
		</div>
	</footer>
</body>
